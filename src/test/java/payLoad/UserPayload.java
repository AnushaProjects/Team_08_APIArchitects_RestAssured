...
public class UserPayload {
	...
	private UserLoginPayload userLogin;
	private String userMiddleName;
	private String userPhoneNumber;
	private List<UserRoleMapsPayload> userRoleMaps;
	...
	public UserLoginPayload getUserLogin() {
		return userLogin;
	}
	public void setUserLogin(UserLoginPayload userLogin) {
	...
	public List<UserRoleMapsPayload> getUserRoleMaps() {
		return userRoleMaps;
	}
	public void setUserRoleMaps(List<UserRoleMapsPayload> userRoleMaps) {
